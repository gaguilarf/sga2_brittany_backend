...
export class EnrollmentResponseDto {
    ...
    @ApiProperty({ description: 'Modality', example: 'Presencial', required: false })
    modalidad?: string;

    @ApiProperty({ description: 'Schedule', example: 'Lunes y Miércoles 6pm-8pm', required: false })
    horario?: string;

    @ApiProperty({ description: 'Level', example: 'Básico', required: false })
    nivel?: string;

    @ApiProperty({ description: 'Enrollment type', example: 'Nueva', required: false })
    ...
    @ApiProperty({ description: 'Receipt number', example: 'B001-00123', required: false })
    numeroBoleta?: string;
