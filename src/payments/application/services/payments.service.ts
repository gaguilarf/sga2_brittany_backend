...
export class PaymentsService {
    ...
    async create(createPaymentDto: CreatePaymentDto): Promise<PaymentResponseDto> {
        try {
            this.logger.log(`Creating new payment for enrollment ID: ${createPaymentDto.enrollmentId}`);
    ...
    async update(id: number, updatePaymentDto: UpdatePaymentDto): Promise<PaymentResponseDto> {
        try {
            ...
            this.logger.error(`Error updating payment ${id}: ${error.message}`, error.stack);
            throw error;
        }
    }
    ...
    async remove(id: number): Promise<void> {
        try {
            ...
            this.logger.error(`Error removing payment ${id}: ${error.message}`, error.stack);
            throw error;
        }
    }
